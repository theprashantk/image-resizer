 ...
 * <h3>Thread Safety</h3>
 * The {@link ImageScalar} class is <strong>thread-safe</strong> (as all the methods
...
public class ImageScalar {
	...
	public static final boolean respectTransparency = false; 
	...
	public static enum Method {
		 ...
		 * {@link ImageScalar#THRESHOLD_QUALITY_BALANCED} or
		 * {@link ImageScalar#THRESHOLD_BALANCED_SPEED} thresholds as cut-offs to
	...
	public static enum Mode {
		 ...
		 * 
		 * See "Image Proportions" in the {@link ImageScalar} class description for
		 * more detail.
		 */
		AUTOMATIC,
		/**
	 ...
	 * {@link ImageScalar#DEBUG} is <code>true</code>; otherwise the VM will be
	 ...
	 * 
	 * @see ImageScalar#LOG_PREFIX
	 * @see ImageScalar#LOG_PREFIX_PROPERTY_NAME
	 */
	protected static void log(int depth, String message, Object... params) {
		if (ImageScalar.DEBUG) {
			System.out.print(ImageScalar.LOG_PREFIX);
	...
	protected static BufferedImage createOptimalImage(BufferedImage src,
		...
		int colorPalet = (respectTransparency) ? (src.getTransparency() == Transparency.OPAQUE ? BufferedImage.TYPE_INT_RGB
	...
	protected static BufferedImage copyToOptimalImage(BufferedImage src)
		...
		int type = respectTransparency ?  (src.getTransparency() == Transparency.OPAQUE ? BufferedImage.TYPE_INT_RGB
				: BufferedImage.TYPE_INT_ARGB) : BufferedImage.TYPE_INT_RGB;
	 ...
	 * method utilizes the {@link ImageScalar#THRESHOLD_QUALITY_BALANCED} and
	 * {@link ImageScalar#THRESHOLD_BALANCED_SPEED} thresholds when selecting which
	...
	protected static Method determineScalingMethod(int targetWidth,
		...
		if (length <= ImageScalar.THRESHOLD_QUALITY_BALANCED)
			result = Method.QUALITY;
		else if (length <= ImageScalar.THRESHOLD_BALANCED_SPEED)
